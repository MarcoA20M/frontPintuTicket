          ...
          <nav>
            <ul className="sidebar-nav">
              ...
              <li className="sidebar-nav-item">
                <Link
                  to="/ticketsIngeniero"
                  className={`sidebar-nav-link ${location.pathname === "/ticketsIngeniero" ? "active" : ""}`}
                >
                  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
              ...
              <li className="sidebar-nav-item">
                <Link
                  to="/seguimiento" className={`sidebar-nav-link ${location.pathname === "/seguimiento" ? "active" : ""}`}
                >
                  <svg xmlns="http://www.w3.org/2000/svg" width="26" height="26" fill="currentColor" class="bi bi-ticket" viewBox="0 0 16 16">
