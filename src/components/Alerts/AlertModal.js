...
export default function AlertModal({ visible, title = 'Alerta', message = '', onClose, backdropOpacity = 0.20, variant = 'default', ebColor = '#dedec8ff', ebSpeed = 1, ebChaos = 0.10, ebThickness = 2 }) {
  ...
  const actionBtn = {
    padding: '8px 14px', borderRadius: 8, border: 'none', cursor: 'pointer', background: '#0b74ff', color: '#fff', fontWeight: 600
  };
